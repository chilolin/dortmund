...
function playAccompany(mero_array,chord_array,unit_time){
  ...
  for (t=0; t<32; t++){
    ...
    if (s == 0){
        ...
        osc_chord0.frequency.value = Object.entries(chord_array)[Math.floor(t/8)][1][note_array[0]];
        ...
        osc_chord1.frequency.value = Object.entries(chord_array)[Math.floor(t/8)][1][note_array[1]];
        ...
        osc_chord2.frequency.value = Object.entries(chord_array)[Math.floor(t/8)][1][note_array[2]];
